...
/**
 * The application turns off any automatic web page generate done by Spring (spring.resources.add-mappings=false). This is done to improve exception handling.
